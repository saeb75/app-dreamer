  ...
  return (
    <Pressable
      ...
      <MotiView
        ...
        <View className=" relative h-full w-full flex-row justify-end">
          {/* Background Image (First Image) */}

          <MotiView
            animate={{
              width: currentImage === 0 ? '90%' : '20%',
            }}
            transition={{
              type: 'timing',
              duration: 2500,
            ...
            <Image source={{ uri: imageUrl1 }} className="h-full w-full" />
          </MotiView>
          {/* Foreground Image (Second Image) with clipping */}
          <MotiView
            animate={{
              width: currentImage === 0 ? '20%' : '90%',
            }}
            transition={{
              type: 'timing',
              duration: 2500,
            ...
            className="absolute bottom-0 left-0 top-0 w-full overflow-hidden">
            <Image source={{ uri: imageUrl2 }} className="h-full w-full" />
          </MotiView>
        </View>
